...
- Run `pnpm check` and keep it green before committing.
- After changing production dependencies, run `pnpm --filter dsh-plugin-desktop verify:notices` to refresh the third-party notices and commit the updated `dsh-plugin-desktop/THIRD_PARTY_NOTICES.md`.
