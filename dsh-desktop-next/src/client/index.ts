...
import { installDesktopSettingsStyles } from '../../../dsh-plugin-desktop/src/client/desktop-settings-styles.ts'
import { installSidebarFooterStyles } from '../../../dsh-plugin-desktop/src/client/sidebar-footer-styles.ts'
