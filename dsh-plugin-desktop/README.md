...
Beta version `2.0.11-beta.5` is written to `dsh-plugin-desktop\dist\Yootun-Agent-Beta-2.0.11-beta.5-x64-Setup.exe`; the unpacked application is `dsh-plugin-desktop\dist\win-unpacked\Yootun-Agent Beta.exe` for smoke testing.<!-- brand:plugin-artifact-setup:end -->
