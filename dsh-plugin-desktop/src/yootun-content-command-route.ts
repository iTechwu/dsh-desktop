...
const CONTENT_AUDIT_SOURCE = Object.freeze({ pluginId: 'dsh-plugin-desktop/yootun-content-command', pluginVersion: desktopPackageVersion(), surface: 'human_ui' as const })
