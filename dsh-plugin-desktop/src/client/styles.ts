...
body:is([data-dsh-desktop-mode="extended"], [data-dsh-desktop-mode="advanced"]) [data-slot="sidebar.settings"] { --dsh-sidebar-footer-control-height: 36px; --dsh-sidebar-footer-control-gap: 4px; }
