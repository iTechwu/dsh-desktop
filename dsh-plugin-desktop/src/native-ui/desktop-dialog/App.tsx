  ...
  return <><DesktopFrame /><main className="dshNativeContent flex flex-col p-5">
    <section className="flex gap-4" role="dialog" aria-labelledby="desktop-dialog-title" aria-describedby={describedBy}>
      ...
      <div className="min-w-0 flex-1">
        ...
        {state.advisory === undefined ? null : <div className="mt-3 rounded-md border border-amber-600/40 bg-amber-500/10 px-3 py-2.5 text-sm leading-relaxed text-amber-950 dark:border-amber-400/40 dark:text-amber-100" id="desktop-dialog-advisory">
