...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: `Update or uninstall the failed third-party plugins in DSH Terminal, then restart ${PRODUCT_NAME}.`,
    ...
    restart: `Restart ${PRODUCT_NAME}`,
    dismiss: 'Dismiss',
    updateAvailableTitle: `${PRODUCT_NAME} Update Available`,
    updateAvailableMessage: version => `${PRODUCT_NAME} ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside Sensteed Agent Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: `${PRODUCT_NAME} could not check for updates.`,
    tryAgainLater: 'Please try again later.',
    upToDateTitle: `${PRODUCT_NAME} Is Up to Date`,
    upToDateMessage: `No newer version of ${PRODUCT_NAME} is available.`,
    installedVersion: version => `Installed version: ${version}`,
    installerUnavailable: 'Installer downloads are unavailable in this build.',
    updateDownloadedTitle: `${PRODUCT_NAME} Update Downloaded`,
    updateReady: version => `${PRODUCT_NAME} ${version} is ready to install.`,
    macInstallInstructions: `The disk image has opened. Replace ${PRODUCT_NAME} in Applications, then reopen it.`,
    windowsInstallQuestion: `Restart ${PRODUCT_NAME} and run the installer now?`,
    ...
    updateInstalled: version => `${PRODUCT_NAME} ${version} has been installed.`,
    ...
    terminalErrorMessage: `${PRODUCT_NAME} could not open a terminal.`,
    diagnosticsErrorTitle: 'Unable to Export Diagnostics',
    diagnosticsErrorMessage: `${PRODUCT_NAME} could not export the diagnostic archive.`,
  ...
  zh: {
    ...
    pluginRecoveryInstructions: `请在 DSH 终端中更新或卸载加载失败的第三方插件，然后重启 ${PRODUCT_NAME}。`,
    ...
    restart: `重启 ${PRODUCT_NAME}`,
    dismiss: '关闭',
    updateAvailableTitle: `${PRODUCT_NAME} 有可用更新`,
    updateAvailableMessage: version => `${PRODUCT_NAME} ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？Sensteed Agent Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: `${PRODUCT_NAME} 无法检查更新。`,
    tryAgainLater: '请稍后重试。',
    upToDateTitle: `${PRODUCT_NAME} 已是最新版本`,
    upToDateMessage: `当前没有更新版本的 ${PRODUCT_NAME}。`,
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '此构建不支持下载安装包。',
    updateDownloadedTitle: `${PRODUCT_NAME} 更新已下载`,
    updateReady: version => `${PRODUCT_NAME} ${version} 已可安装。`,
    macInstallInstructions: `磁盘映像已打开。请替换“应用程序”中的 ${PRODUCT_NAME}，然后重新打开。`,
    windowsInstallQuestion: `现在重启 ${PRODUCT_NAME} 并运行安装程序？`,
    ...
    updateInstalled: version => `${PRODUCT_NAME} ${version} 已安装。`,
    removeInstallerQuestion: path => `是否删除下载的安装包以释放磁盘空间？\n\n${path}`,
    deleteInstaller: '删除安装包',
    keepInstaller: '保留安装包',
    terminalErrorTitle: '无法打开 DSH 终端',
    terminalErrorMessage: `${PRODUCT_NAME} 无法打开终端。`,
    diagnosticsErrorTitle: '无法导出诊断信息',
    diagnosticsErrorMessage: `${PRODUCT_NAME} 无法导出诊断包。`,
