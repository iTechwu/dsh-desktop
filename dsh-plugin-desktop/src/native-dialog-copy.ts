...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    dismiss: 'Dismiss',
    updateAvailableTitle: 'Yootun-Agent Update Available',
    updateAvailableMessage: version => `Yootun-Agent ${version} is available.`,
    ...
    updateCheckFailedMessage: 'Yootun-Agent could not check for updates.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'Yootun-Agent Is Up to Date',
    upToDateMessage: 'No newer version of Yootun-Agent is available.',
    installedVersion: version => `Installed version: ${version}`,
    installerUnavailable: 'Installer downloads are unavailable in this build.',
    updateDownloadedTitle: 'Yootun-Agent Update Downloaded',
    updateReady: version => `Yootun-Agent ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace Yootun-Agent in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart Yootun-Agent and run the installer now?',
    ...
    updateInstalled: version => `Yootun-Agent ${version} has been installed.`,
    ...
    terminalErrorMessage: 'Yootun-Agent could not open a terminal.',
    diagnosticsErrorTitle: 'Unable to Export Diagnostics',
    diagnosticsErrorMessage: 'Yootun-Agent could not export the diagnostic archive.',
  ...
  zh: {
    ...
    dismiss: '关闭',
    updateAvailableTitle: 'Yootun-Agent 有可用更新',
    updateAvailableMessage: version => `Yootun-Agent ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？Sensteed Agent Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: 'Yootun-Agent 无法检查更新。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'Yootun-Agent 已是最新版本',
    upToDateMessage: '当前没有更新版本的 Yootun-Agent。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '此构建不支持下载安装包。',
    updateDownloadedTitle: 'Yootun-Agent 更新已下载',
    updateReady: version => `Yootun-Agent ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 Yootun-Agent，然后重新打开。',
    windowsInstallQuestion: '现在重启 Yootun-Agent 并运行安装程序？',
    ...
    updateInstalled: version => `Yootun-Agent ${version} 已安装。`,
    removeInstallerQuestion: path => `是否删除下载的安装包以释放磁盘空间？\n\n${path}`,
    deleteInstaller: '删除安装包',
    keepInstaller: '保留安装包',
    terminalErrorTitle: '无法打开 DSH 终端',
    terminalErrorMessage: 'Yootun-Agent 无法打开终端。',
    diagnosticsErrorTitle: '无法导出诊断信息',
    diagnosticsErrorMessage: 'Yootun-Agent 无法导出诊断包。',
