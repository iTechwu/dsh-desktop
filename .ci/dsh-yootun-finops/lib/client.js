window.__ModuleLoader__.load({
  ...
  factory: (require) => { var module = { exports: {} }; var exports = module.exports;
    ...
    const activeStateCss = `.yf-range-control button.is-active,.yf-range-small button.is-active{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-base);font-weight:650}.yf-range-control button:disabled{opacity:.45;cursor:default}.yf-refresh-error{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;background:color-mix(in srgb,var(--dsw-alias-state-error-primary) 9%,transparent);color:var(--dsw-alias-state-error-primary)}.yf-refresh-error button{min-height:32px;padding:0 11px;border:1px solid var(--dsw-alias-border-l2);border-radius:6px;background:var(--dsw-alias-bg-layer-1);color:inherit;font:inherit;cursor:pointer}.yf-table-scroll{max-width:100%;overflow-x:auto}.yf-table{min-width:940px}@media(max-width:480px){.yf-table th:nth-child(n+5),.yf-table td:nth-child(n+5){display:table-cell}}`
