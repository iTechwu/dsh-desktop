...
function Overlay({ t }) {
  ...
  return h('div', { className: 'yr-overlay', role: 'dialog', 'aria-modal': true, 'aria-labelledby': 'yr-title' }, h('main', { className: 'yr-shell', ref: shellRef, tabIndex: -1, 'aria-labelledby': 'yr-title', 'aria-busy': loading || busy },
