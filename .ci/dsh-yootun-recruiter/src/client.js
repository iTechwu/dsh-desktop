  ...
  return h('div', { className: 'yr-page' },
    ...
    h('section', { className: 'yr-panel yr-intake-panel' },
      ...
      h('div', { className: 'yr-intake-grid' },
        ...
        h('div', { className: 'yr-intake-editor' }, h('label', { htmlFor: 'yr-role-brief' }, t('pasteRequirement')), h('textarea', { id: 'yr-role-brief', className: 'yr-intake-textarea', value: input, onChange: event => setInput(event.target.value), placeholder: t('addRole') }), h('div', { className: 'yr-intake-footer' }, h('span', { className: 'yr-muted', role: 'status' }, busy ? t('processing') : message), h('button', { type: 'button', className: 'yr-primary', disabled: busy, onClick: generate }, h(IconDataOutline16, { size: 14 }), t('generateDraft')))),
      ),
    ),
