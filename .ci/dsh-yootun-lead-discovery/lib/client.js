window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const interactionCss = `.yl-platform-options button:disabled,.yl-query-wrap input:disabled{opacity:.45;cursor:default}`
