window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const cssOverrides = ".pc_row,.pc_item,.pc_detail,.pc_floatPanel,.pc_modalCard{border-radius:8px}.pc_backTop{background:var(--dsw-alias-bg-layer-2)}.pc_modalBackdrop{background:color-mix(in srgb,var(--dsw-alias-bg-base) 62%,transparent)}@media(max-width:640px){.pc_list{grid-template-columns:1fr}.pc_floatPanel{left:12px;right:12px;width:auto;max-height:70vh}.pc_restartBtn{right:12px}.pc_relaunchFloat{left:12px}.pc_aiToggle,.pc_sourcesFloat,.pc_modeFloat{right:12px}}";
