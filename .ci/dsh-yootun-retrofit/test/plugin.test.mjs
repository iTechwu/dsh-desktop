...
test('retrofit package exposes a complete database-first workspace', async () => {
  ...
  assert.match(client, /className: 'yr-search-input', value: query, maxLength: 500, disabled: busy/u)
  assert.match(client, /\.yr-state button:disabled\{cursor:not-allowed;opacity:\.45\}/u)
