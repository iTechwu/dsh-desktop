window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = `.yro-button{display:grid;width:36px;height:36px;place-items:center;border:0;border-radius:6px;background:transparent;color:var(--dsw-alias-label-secondary);cursor:pointer}.yro-button:hover{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary)}.yro-overlay{position:fixed;inset:0;z-index:510;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary)}.yro-shell{display:grid;grid-template-rows:auto auto auto minmax(0,1fr);width:100%;height:100%;overflow:hidden}.yro-header{display:flex;min-height:72px;align-items:center;justify-content:space-between;padding:16px 24px;border-bottom:1px solid var(--dsw-alias-border-l1)}.yro-title-row{display:flex;align-items:center;gap:10px}.yro-header h1{margin:0;font-size: 20px;line-height:1.25;letter-spacing:0}.yro-header p{margin:5px 0 0;color:var(--dsw-alias-label-secondary);font-size:13px}.yro-ready{width:7px;height:7px;border-radius:50%;background:var(--dsw-alias-state-success-primary);box-shadow:0 0 0 3px color-mix(in srgb,var(--dsw-alias-state-success-primary) 16%,transparent)}.yro-icon-button{display:grid;width:36px;height:36px;place-items:center;border:1px solid var(--dsw-alias-border-l1);border-radius:6px;background:var(--dsw-alias-bg-layer-1);color:inherit;cursor:pointer}.yro-toolbar{display:grid;grid-template-columns:minmax(150px,210px) minmax(280px,1fr) auto auto;gap:10px;padding:22px clamp(18px,3vw,42px) 12px}.yro-platform-select,.yro-search-box{height:44px;border:1px solid var(--dsw-alias-border-l1);border-radius:6px;background:var(--dsw-alias-bg-layer-1)}.yro-platform-select{position:relative;display:flex;flex-direction:column;justify-content:center;padding:4px 12px}.yro-platform-select span{color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary));font-size:10px;line-height:1}.yro-platform-select select{width:100%;border:0;outline:0;background:transparent;color:inherit;font:inherit;font-size:13px}.yro-search-box{display:flex;align-items:center;gap:9px;padding:0 13px;color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary))}.yro-search-box input{width:100%;min-width:0;border:0;outline:0;background:transparent;color:var(--dsw-alias-label-primary);font:inherit;font-size:14px}.yro-primary,.yro-secondary,.yro-state button{display:inline-flex;min-height:44px;align-items:center;justify-content:center;gap:7px;padding:0 16px;border-radius:6px;font:inherit;font-size:13px;white-space:nowrap;cursor:pointer}.yro-primary{border:1px solid transparent;background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground)}.yro-secondary,.yro-state button{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.yro-primary:disabled,.yro-secondary:disabled{cursor:not-allowed;opacity:.45}.yro-privacy{margin:0;padding:0 clamp(18px,3vw,42px) 18px;color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary));font-size:12px}.yro-content{overflow:auto;border-top:1px solid var(--dsw-alias-border-l1);padding:0 clamp(18px,3vw,42px) 40px}.yro-source-bar{display:flex;min-height:42px;align-items:center;gap:8px;color:var(--dsw-alias-label-secondary);font-size:12px}.yro-source-dot{width:7px;height:7px;border-radius:50%;background:var(--dsw-alias-state-success-primary)}.yro-source-bar.is-external .yro-source-dot{background:var(--dsw-alias-state-warn-primary)}.yro-source-time{margin-left:auto;color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary))}.yro-metrics{display:grid;grid-template-columns:repeat(4,minmax(120px,1fr));border-block:1px solid var(--dsw-alias-border-l1)}.yro-metric{display:grid;grid-template-columns:1fr auto auto;align-items:baseline;gap:6px;padding:16px 18px;border-right:1px solid var(--dsw-alias-border-l1)}.yro-metric:last-child{border-right:0}.yro-metric span{color:var(--dsw-alias-label-secondary);font-size:12px}.yro-metric strong{font-size:24px;line-height:1;letter-spacing:0}.yro-metric small{color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary));font-size:11px}.yro-section-head{padding:22px 0 12px}.yro-section-head h2,.yro-external-note h2,.yro-state h2{margin:0;font-size:15px;letter-spacing:0}.yro-section-head p,.yro-external-note p,.yro-state p{margin:5px 0 0;color:var(--dsw-alias-label-secondary);font-size:12px}.yro-list{border-top:1px solid var(--dsw-alias-border-l1)}.yro-item{display:grid;grid-template-columns:minmax(0,1fr) 190px;gap:22px;padding:18px 4px;border-bottom:1px solid var(--dsw-alias-border-l1)}.yro-item-head{display:flex;align-items:center;gap:12px;color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary));font-size:11px}.yro-platform{color:var(--dsw-alias-label-secondary);font-weight:600}.yro-item h3{margin:8px 0 5px;font-size:15px;line-height:1.4;letter-spacing:0}.yro-item p{display:-webkit-box;overflow:hidden;margin:0;color:var(--dsw-alias-label-secondary);font-size:13px;line-height:1.6;-webkit-box-orient:vertical;-webkit-line-clamp:3}.yro-item-side{display:flex;flex-direction:column;align-items:flex-end;justify-content:space-between;gap:16px}.yro-counts{display:flex;gap:22px}.yro-counts span{display:flex;flex-direction:column;align-items:flex-end;color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary));font-size:10px}.yro-counts b{color:var(--dsw-alias-label-primary);font-size:16px}.yro-item a{display:inline-flex;align-items:center;gap:6px;color:var(--dsw-alias-label-primary);font-size:12px;text-decoration:none}.yro-item a:hover{text-decoration:underline}.yro-empty,.yro-state,.yro-loading{display:flex;min-height:360px;align-items:center;justify-content:center;flex-direction:column;text-align:center}.yro-empty-icon,.yro-state-icon{display:grid;width:44px;height:44px;place-items:center;border-radius:6px;background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary)}.yro-empty h3{margin:14px 0 4px;font-size:16px}.yro-empty p{max-width:470px;margin:0;color:var(--dsw-alias-label-secondary);font-size:13px}.yro-examples{display:flex;align-items:center;justify-content:center;gap:8px;margin-top:22px;color:color-mix(in srgb,var(--dsw-alias-label-tertiary) 75%,var(--dsw-alias-label-primary));font-size:12px}.yro-examples button{padding:7px 10px;border:1px solid var(--dsw-alias-border-l1);border-radius:6px;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer}.yro-external-note{display:flex;align-items:flex-start;gap:10px;padding:18px 0;color:color-mix(in srgb,var(--dsw-alias-state-warn-primary) 50%,var(--dsw-alias-label-primary))}.yro-external-note p{color:var(--dsw-alias-label-secondary)}.yro-external-item{grid-template-columns:minmax(0,1fr) auto}.yro-external-item .yro-item-side{justify-content:center}.yro-state button{min-height:36px;margin-top:18px}.yro-loading{gap:10px;color:var(--dsw-alias-label-secondary)}@media(max-width:900px){.yro-toolbar{grid-template-columns:180px minmax(220px,1fr)}.yro-primary,.yro-secondary{min-height:40px}.yro-metrics{grid-template-columns:repeat(2,1fr)}.yro-metric:nth-child(2){border-right:0}.yro-metric:nth-child(-n+2){border-bottom:1px solid var(--dsw-alias-border-l1)}}@media(max-width:620px){.yro-header{padding:15px 16px}.yro-header h1{font-size:19px}.yro-toolbar{grid-template-columns:1fr 1fr;padding:16px}.yro-platform-select,.yro-search-box{grid-column:1/-1}.yro-primary,.yro-secondary{padding:0 10px}.yro-privacy{padding:0 16px 14px}.yro-content{padding:0 16px 28px}.yro-metric{grid-template-columns:1fr auto;padding:13px 10px}.yro-metric small{display:none}.yro-item{grid-template-columns:1fr;gap:12px}.yro-item-side{align-items:flex-start;flex-direction:row}.yro-counts span{align-items:flex-start}.yro-examples{flex-wrap:wrap}.yro-source-bar{align-items:flex-start;flex-direction:column;padding:10px 0}.yro-source-time{margin-left:0}.yro-external-item{grid-template-columns:1fr}}`
