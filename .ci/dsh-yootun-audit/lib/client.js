  ...
  factory: (require) => { var module = { exports: {} }; var exports = module.exports;
    ...
    function Overlay({ t }) {
      ...
      if (state.loading && !state.workspace) body = h(Skeleton, { t })
        ...
        const empty = h('div', { className: 'ya-empty', role: 'status' }, h('span', null, filtered ? t('filteredEmpty') : t('empty')), filtered ? h('button', { type: 'button', onClick: () => dispatch({ type: 'clear' }) }, t('clear')) : null)
